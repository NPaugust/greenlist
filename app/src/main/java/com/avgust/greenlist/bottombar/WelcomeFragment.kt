package com.avgust.greenlist.bottombar
...
import com.avgust.greenlist.adapter.PostListAdapter
import com.avgust.greenlist.databinding.FragmentWelcomeBinding
import com.avgust.greenlist.data.PostModel
import com.google.android.material.snackbar.Snackbar
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import java.util.*

class WelcomeFragment : Fragment(R.layout.fragment_welcome), (PostModel) -> Unit {
        ...
        binding.toolBarMain.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.search_recipe -> {
                    ...
                    searchView.queryHint = "List name or type"
                    val editTextView = searchView.findViewById<EditText>(R.id.search_src_text)
                    editTextView.setTextColor(resources.getColor(R.color.white))
                    editTextView.setHintTextColor(
